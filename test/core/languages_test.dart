...
void main() {
  ...
  test('По умолчанию автомат выбирает только между турецким и узбекским', () {
    // Русский по тексту почти не выигрывает (пробы впустую), казахский
    // выигрывает ложно; их человек узнаёт на слух и включает сам.
    expect(kDefaultDetectionCandidates, ['tr-TR', 'uz-UZ']);
  });
}
