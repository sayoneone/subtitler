/// Строки интерфейса — в одном месте (§12 спецификации): так их проще
/// вычитать целиком и не разойтись в словах между экранами.
///
/// Здесь только то, что пишут сами экраны. Названия шагов обработки
/// (`ProcessingStepTitle`), тексты ошибок (`describeError`) и подписи
/// кнопок ошибок (`UserErrorActionLabel`) живут рядом с логикой в
/// `lib/app/`: их проверяют тесты контроллера.
abstract final class AppStrings {
  ...
  static const prepareHint = 'ищем паузы в речи — может занять пару проходов';
