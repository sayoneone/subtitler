...
class CueTimeline {
  CueTimeline(Iterable<Cue> cues)
    ...
    // Реплики сегментатора не перекрываются, а время в программе не
    // правится. Перекрытие возможно только в сессии, поправленной вне
    // программы; оверлей и тогда не должен молча терять текст.
    var maxEnd = -1;
    _maxEndUpTo = [
