...
class AppRuntime {
  ...
  static Future<AppRuntime> prepare({DebugLog? log}) async {
    ...
    // На Android кеш система чистит сама, когда не хватает места. Рабочие
    // файлы пусть лежат в кеше, а запасная папка для результата — среди
    // постоянных файлов приложения. Но обычно она не нужна: видео из
    // «Выбрать видео» — копия в кеше (file_selector_android кладёт её в
    // getCacheDir()/<uuid>/), и результат с сессией пишутся рядом с ней,
    // то есть тоже в кеш, и могут пропасть вместе с ним (спецификация, §9).
