...
class AppController extends ChangeNotifier {
  ...
  /// сказать в кадре теперь есть что. Сам текст виден в кадре и попадёт в
  /// видео при любом статусе — правило общее (`subtitleText`). Если текст
  /// стёрли, а распознанного оригинала нет, реплика снова «речи нет» — и
  /// в списке снова серая строка.
  ///
